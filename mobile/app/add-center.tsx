...
import { ID } from 'react-native-appwrite'; // Or react-native-appwrite
...
export default function AddCenterScreen() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            Alert.alert('Success', 'Center added successfully! Geofences will update shortly.');
            router.back();
        } catch (error: any) {
            Alert.alert('Error', error.message || 'Failed to create center');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <SafeAreaView className="flex-1 bg-slate-50">
            <View className="bg-white p-4 items-center border-b border-gray-100 flex-row justify-between">
                ...
                <Text className="text-lg font-bold text-center shrink" numberOfLines={1} adjustsFontSizeToFit>Add Center</Text>
            ...
            <ScrollView className="p-6 space-y-4">
                ...
                <View>
                    ...
                    <TouchableOpacity onPress={handleGetCurrentLocation} className="bg-slate-200 p-3 rounded-xl items-center">
                        <Text className="text-slate-700">📍 Use Current Location</Text>
                    </TouchableOpacity>
                </View>
                ...
                <TouchableOpacity
                    ...
                    disabled={loading}
                >
                    {loading ? <ActivityIndicator color="white" /> : <Text className="text-white font-bold text-lg">Save Center</Text>}
                </TouchableOpacity>
