        ...
        return (
            <div className="flex flex-col gap-4 items-center">
                <div className="text-xl font-semibold border-b border-border pb-2 mb-2 animate-pulse text-primary dark:text-primary-foreground">
                    ...
                    {hasGroupActiveSession && (volunteerIds?.length ?? 0) > 1 ? "Active Group Session" : `Currently Checked In`}
                </div>
                <Button
                    size="lg"
                    variant="destructive"
                ...
                >
                    {isLoading ? "Processing..." : (hasGroupActiveSession && (volunteerIds?.length ?? 0) > 1 ? "CHECK OUT GROUP" : "CHECK OUT")}
                </Button>
