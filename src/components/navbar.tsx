...
export function Navbar() {
    ...
    return (
        <nav className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50 w-full max-w-[100vw] overflow-x-hidden">
